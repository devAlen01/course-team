    ...
    return (
        <div className={styles.Section5}>
            <div className="container">
                <h1 className={styles.title}>Нам доверяют тысячи <br /> довольных учеников</h1>
                <p className={styles.description}>Мы предоставляем множество функций, которые вы можете <br /> использовать. Постепенное накопление информации</p>
